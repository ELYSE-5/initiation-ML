...
def load_train(nrows=None, save_to_hdf=True):
...
def load_test(nrows=None, save_to_hdf=True):
...
def fast_load_data(path, nrows=None, save_to_hdf=True):
    ...
    if file_extension == '.hdf':
        ...
        raise FileExistsError("Wrong file extension.")
